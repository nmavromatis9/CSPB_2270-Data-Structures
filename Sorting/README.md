# Sorting
In this assignment you will implement a Sorting ADT
...
tests\              : Tests folder  
test_Sorting.cpp : Tests implemented for you / your personal tests  



For your final submission you submitt Sorting.cpp and Sorting.h files. Any other changes in other folders will be ignored in grading process but feel free to change them if you want to test/debug something.
...
```console
jovyan@jupyter-yourcuid:~$ git clone https://github.com/Colorado-CompSci-Ugrad/Sorting.git
```
### If you want to use vscode environment
Then open the VScode app through JupyterHub and open BSST folder from vscode.

Now your environment is set up, change Sorting.cpp and Sorting.h files and eventually press CTRL+SHIFT+B to compile your code.
...
```console
jovyan@jupyter-yourcuid:~$ cd Sorting
...
In this assignment you'll implement a Sorting ADT. We've covered the struct and associated operations in the
