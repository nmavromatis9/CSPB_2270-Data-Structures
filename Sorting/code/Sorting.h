...
public:
  ...
  //swaps data at indices in vector.
  void swap(int* val1, int* val2);
  //helper merge function, does what merge() intends but returns a vector, making it easier to work with mergesort().
  vector<int> mergeH(vector<int>& left, vector<int>& right);
private:
